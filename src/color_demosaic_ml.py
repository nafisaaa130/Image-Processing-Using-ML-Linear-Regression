...
def PSNR(orig_img,lin_regression_img):
    orig_matrix = cv2.imread(orig_img)
    lin_matrix = cv2.imread(lin_regression_img)

    squared_matrix = np.square(np.subtract(orig_matrix, lin_matrix))
    MSE = squared_matrix.mean()
...
if __name__ == "__main__":
    # inputFile = '../images/bird.jpg'
    inputFile = '../images/kodim05.png'
    bayerFile = '../images/bayer.png'
    outputFile = '../images/linear_regression_bike.png'

    #generated image using matlab's built-in demosaic function
    matlabFile = '../images/bike_matlab.png'
    ...
    # #psnr for matlab image
    # peaksnr_matlab = PSNR(inputFile, matlabFile)
    # print("Peak signal-to-noise ratio for matlab image ", peaksnr_matlab)

    # #psnr for matlab image
    # peaksnr_python = PSNR(inputFile, outputFile)
    # print("Peak signal-to-noise ratio for image generated by this script ", peaksnr_python)